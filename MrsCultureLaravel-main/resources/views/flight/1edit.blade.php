      ...
      <div id="flight-form-id" style="padding: 20px; width: 650px; margin: 40px; margin-left: 100px; background-color: rgba(255, 255, 255, 0.756); border-radius: 10px; ">
        <form action="flightBooking" method="POST">
          ...
          <div class="form-group" style="display: flex;" style="margin-bottom: 20px;">
            ...
            <input required="" type="text" class="form-control" name="from" id="form" value="{{$flight->from}}" readonly>
            
          </div>
      
          <div class="form-group" style="display: flex;" style="margin-bottom: 20px;">
            <label style="width: 130px;" for="to" style="padding-right: 20px;">To</label>
            <input required="" type="text" class="form-control" name="to" id="form" value="{{$flight->to}}" readonly>
          </div>
          ...
          <div class="form-group" style="display: flex;" style="margin-bottom: 20px;">
            ...
            <input required="" type="date" class="form-control" style="margin-bottom: 10px;" name="departuredate" value="{{$flight->departuredate}}" readonly>
        
          </div>
          <div class="form-group" style="display: flex;" style="margin-bottom: 20px;">
            <label style="width: 130px;" for="departuredate" style="padding-right: 20px;">Time</label>
            <input required="" type="time" class="form-control" style="margin-bottom: 10px;" name="time" value="{{$flight->time}}" readonly>
